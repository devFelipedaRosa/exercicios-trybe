...
function Coffee() {
  ...
  const currentCoffee = coffeeList.find((coffee: string) => coffee.slug === params.coffee);
  ...
  return (
    ...
    <div>
      ...
      <ul>
        {
          currentCoffee.ingredients.map((ingredient: string) => <li key={ ingredient }>{ ingredient }</li>)
        }
      </ul>
    </div>
